...
input2.setAttribute("onclick", "erase()");
...
input15.setAttribute("onclick", "show('.')");
...
input16.setAttribute("value", "0");
input16.setAttribute("onclick", "show('0')");
...
function result() {
    let press = document.getElementById("result").value;
    let final = eval(press);
